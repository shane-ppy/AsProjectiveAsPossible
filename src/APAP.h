...
void warpAndFuseImage(const cv::Mat &img1, const cv::Mat &img2, const Eigen::Matrix3f &H, cv::Mat &img12H);
...
int GlobalHomography(const char* img1_path, const char* img2_path, Eigen::MatrixXf &inlier, Eigen::MatrixXf &A, Eigen::Matrix3f &T1, Eigen::Matrix3f &T2, int &offX, int &offY, int &cw, int &ch, cv::Mat &img1, cv::Mat &img2, cv::Mat &img12H);
